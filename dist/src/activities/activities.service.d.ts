...
export declare class ActivitiesService {
    ...
    constructor(activitiesRepo: ActivitiesRepository);
    ...
    createActivity(dto: CreateActivityDto, agentId: string): Promise<{
        id: string;
        createdAt: Date;
        description: string | null;
        status: string;
    ...
    addActivityComment(activityId: string, authorId: string, dto: CreateCommentDto): Promise<{
        id: string;
        createdAt: Date;
        content: string;
        authorId: string;
