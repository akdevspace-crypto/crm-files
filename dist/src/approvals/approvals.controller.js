...
let ApprovalsController = class ApprovalsController {
    ...
    async createRequest(req, type, details) {
    ...
    async reviewRequest(id, req, status, notes) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ApprovalsController.prototype, "reviewRequest", null);
exports.ApprovalsController = ApprovalsController = __decorate([
    (0, common_1.Controller)('v1/approvals'),
