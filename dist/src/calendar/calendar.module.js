...
const calendar_cron_1 = require("./calendar.cron");
...
exports.CalendarModule = CalendarModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [calendar_service_1.CalendarService, calendar_repository_1.CalendarRepository, calendar_cron_1.CalendarCronService],
