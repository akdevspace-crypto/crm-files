...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve dynamic metrics and layouts for the specified dashboard preset' }),
    __param(0, (0, common_1.Query)('type')),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dashboard_query_dto_1.DashboardQueryDto]),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "getDashboardAnalytics", null);
